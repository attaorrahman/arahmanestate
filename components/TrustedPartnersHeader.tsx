...
export default function TrustedPartnersHeader() {
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-10">
        <div className="flex items-center gap-3 bg-[#0D0D0D] rounded-sm px-5 py-3">
          <div className="flex items-center gap-1">
            ...
            <div className="flex flex-col gap-0.5 ml-1">
              ...
              <span className="text-gray-400 text-[10px] font-body leading-none">{t('partners.excellent')}</span>
            </div>
          </div>
        </div>

        <p className="font-body text-gray-700 text-sm">
          {t('partners.matters')} <span className="font-semibold text-[#C9A84C]">{t('partners.matters2')}</span> {t('partners.matters3')}{' '}
          <span className="font-semibold text-[#C9A84C]">{t('partners.matters4')}</span>
        </p>
        ...
        <div className="flex items-center gap-2.5 bg-gray-50 border border-gray-100 rounded-sm px-5 py-3">
          ...
          <div>
            ...
            <p className="font-body text-gray-500 text-[10px]">{t('partners.reviews')}</p>
          </div>
        </div>
      </div>
