...
const stats = [
  { icon: Building2, value: 109, suffix: '+', label: 'Total Properties' },
  { icon: Users, value: 2400, suffix: '+', label: 'Happy Clients' },
  { icon: MapPin, value: 7, suffix: '', label: 'Emirates Covered' },
  { icon: UserCheck, value: 85, suffix: '+', label: 'Expert Agents' },
];
...
function StatItem({ icon: Icon, value, suffix, label, started }: {
  ...
  return (
    <div className="text-center group">
      ...
      <p className="font-display text-5xl font-bold text-[#1A1A1A] mb-2">
...
export default function StatsCounter() {
  ...
  return (
    <section className="py-20 bg-[#F5F0E8]" ref={ref}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <p className="font-body text-[#C9A84C] text-xs tracking-[0.25em] uppercase font-medium mb-2">
            Our Numbers
          </p>
          <h2 className="font-display text-4xl font-bold text-gray-900">
            LuxEstate by the Numbers
          </h2>
        </div>
