...
export default function ContactForm() {
  ...
  return (
    <section className="py-24 bg-[#0D0D0D] relative overflow-hidden" id="contact" dir={dir}>
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="font-display text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight">
              {t('contact.title1')}
              <span className="block italic text-[#C9A84C]">{t('contact.title2')}</span>
            </h2>
            ...
            <div className="space-y-6">
              {[
                { icon: Phone, label: t('contact.phone'), value: '+971 55 775 7123' },
                { icon: Mail, label: t('contact.email_label'), value: 'info@bnhmasterkey.ae' },
                { icon: MapPin, label: t('contact.office'), value: 'DIFC Gate Village, Dubai, UAE' },
          ...
          <div className="bg-white/4 backdrop-blur-sm border border-white/8 rounded-sm p-8">
            {submitted ? (
              <div className="text-center py-12">
                ...
                <h3 className="font-display text-white text-2xl font-bold mb-2">{t('contact.sent')}</h3>
